        ...
        return Padding(
          ...
          child: Container(
            ...
            child: ListView.builder(
              ...
              physics: NeverScrollableScrollPhysics(),
              shrinkWrap: true,
              itemCount: state.orderStatistics.length,
              itemBuilder: (context, index) {
                return summaryInfoColumn(state.orderStatistics[index]['status'],
                    state.orderStatistics[index]['count']);
              },
            ),
          ),
        );
